      ...
      <aside className="w-64 bg-gradient-to-b from-green-800 to-green-900 text-white p-6 space-y-4 border-r border-green-700">
        ...
        <nav className="space-y-2">
          <Link
            ...
            className="flex items-center space-x-3 p-2 rounded-lg hover:bg-green-700 transition-colors"
          >
            <svg
              className="w-5 h-5"
              fill="none"
          ...
          >
            ...
            >
              <path
                ...
                strokeLinejoin="round"
                strokeWidth={2}
                d="M12 6V4m0 2a2 2 0 110 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4"
              />
            </svg>
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-600">
              Gestiona tu plataforma de manera eficiente
            </p>
          </div>
